...
class _GroupSearchState extends State<GroupSearch> {
  ...
  Future<List<dynamic>> getSearchList(String search) async{
    ...
    for(DocumentSnapshot document in datalist){
      Map<String, dynamic>? datafield = document.data() as Map<String, dynamic>?;
      if(datafield != null){
        ...
        if(inTitle.contains(search)||inInfo.contains(search)||inCategories.contains(search)){
          result.add(document);
        }
      }
    }
        ...
        children: [
          TextField(
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: IconButton(onPressed: (){searchController.clear();}, icon: Icon(Icons.clear)),
                ...
                builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot> snapshot){
                  ...
                  return FutureBuilder<List<dynamic>>(
                    ...
                    builder: (context, snapshot){
                      if(snapshot.hasError) return Text('오류가 발생했습니다.');
                      if(snapshot.connectionState == ConnectionState.waiting) return Text('');
                      final List<dynamic> activateRoom = snapshot.data as List<dynamic>;
                        ...
                        itemBuilder: (BuildContext ctx, int idx){
                          return FutureBuilder<DocumentSnapshot>(
                            ...
                            builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot> snapshot){
                              ...
                              var title = data['title'].toString() ?? '', info = data['info'].toString() ?? '', place = data['place'].toString();
