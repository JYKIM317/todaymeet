  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      builder:
        ...
        String fromTime =
            '${bannedFrom.year}년${bannedFrom.month}월${bannedFrom.day}일 ${bannedFrom.hour}:${bannedFrom.minute.toString().length == 1 ? '0${bannedFrom.minute.toString()}' : bannedFrom.minute}';
        String toTime =
            '${bannedTo.year}년${bannedTo.month}월${bannedTo.day}일 ${bannedTo.hour}:${bannedTo.minute.toString().length == 1 ? '0${bannedTo.minute.toString()}' : bannedTo.minute}';
