...
class CustomLoginView extends StatefulWidget {
  ...
  @override
  State<CustomLoginView> createState() => CustomLoginViewState();
}

class CustomLoginViewState extends State<CustomLoginView> {
  ...
  @override
  void didUpdateWidget(covariant CustomLoginView oldWidget) {
