...
class ReviewPage extends StatefulWidget {
  final roomname;
  final roomNum;
  const ReviewPage({Key? key, required this.roomname, required this.roomNum})
      : super(key: key);
                            ...
                            return headcount[index] != _user!.uid
                                ? FutureBuilder<DocumentSnapshot>(
                                    ...
                                    builder: (BuildContext context,
                                      ...
                                      reviewValue['${headcount[index]}manner'] =
                                          data['manner'] ?? 0;
              ...
              for (int i = 0; i < memberUID.length; i++) {
                if (memberUID[i] != _user!.uid) {
                  await FirebaseFirestore.instance
                      ...
                      .doc('${memberUID[i]}')
                      .collection('review')
                      .doc('${widget.roomNum}_${_user!.uid}')
                      .set({'review': reviewParameter});
                  ...
                  await FirebaseFirestore.instance
                      .collection('users')
                      .doc('${memberUID[i]}')
                      .update({'manner': reviewValue['${memberUID[i]}manner']});
                }
              }
