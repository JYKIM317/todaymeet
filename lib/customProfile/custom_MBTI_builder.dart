        ...
        body: Padding(
          ...
          child: Center(
            child: Column(
              ...
              children: [
                Text('MBTI를 선택해주세요', style: TextStyle(fontSize: 32, fontWeight: FontWeight.w700)),
                SizedBox(height: 48),
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  ...
                  TextButton(onPressed: (){
                    ...
                    style: TextStyle(
                        fontSize: 32,
                        color: eiState == true ? Color(0xFF51CF6D) : Colors.grey))
                  ),
                  TextButton(onPressed: (){
                    snState = true;
                    snParameter = 'S';
                    ...
                    style: TextStyle(
                        fontSize: 32,
                        color: snState == true ? Color(0xFF51CF6D) : Colors.grey))
                  ),
                  TextButton(onPressed: (){
                    tfState = true;
                    tfParameter = 'T';
                    ...
                    style: TextStyle(
                        fontSize: 32,
                        color: tfState == true ? Color(0xFF51CF6D) : Colors.grey))
                  ),
                  TextButton(onPressed: (){
                    jpState = true;
                    jpParameter = 'J';
                    ...
                    style: TextStyle(
                        fontSize: 32,
                        color: jpState == true ? Color(0xFF51CF6D) : Colors.grey))
                  ),
                ]),
                SizedBox(height: 24),
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  ...
                  TextButton(onPressed: (){
                    ...
                    style: TextStyle(
                        fontSize: 32,
                        color: eiState == false ? Color(0xFF51CF6D) : Colors.grey))
                  ),
                  TextButton(onPressed: (){
                    snState = false;
                    snParameter = 'N';
                    ...
                    style: TextStyle(
                        fontSize: 32,
                        color: snState == false ? Color(0xFF51CF6D) : Colors.grey))
                  ),
                  TextButton(onPressed: (){
                    tfState = false;
                    tfParameter = 'F';
                    ...
                    style: TextStyle(
                        fontSize: 32,
                        color: tfState == false ? Color(0xFF51CF6D) : Colors.grey))
                  ),
                  TextButton(onPressed: (){
                    jpState = false;
                    jpParameter = 'P';
                    ...
                    style: TextStyle(
                        fontSize: 32,
                        color: jpState == false ? Color(0xFF51CF6D) : Colors.grey))
                  ),
                ]),
                SizedBox(height: 56),
                Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  ...
                  TextButton(onPressed: ()async{
                    mbtiparameter = '$eiParameter$snParameter$tfParameter$jpParameter';
