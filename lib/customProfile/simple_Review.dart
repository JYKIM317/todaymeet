...
class SimpleReview extends StatelessWidget {
  final member;
  final List reviews;
  const SimpleReview({Key? key, required this.member, required this.reviews}) : super(key: key);
                ...
                ListView.separated(
                  ...
                  itemBuilder: (BuildContext ctx, int idx){
                    return FutureBuilder<DocumentSnapshot>(
                        future: FirebaseFirestore.instance.collection('users').doc(member).collection('review').doc('${reviews[idx].id}').get(),
